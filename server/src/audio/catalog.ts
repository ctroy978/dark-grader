...
const CORE_CATALOG: AudioClipDef[] = [
  ...
  },
  {
    id: "act_runesinger",
    kind: "sfx",
    text: "focused rune spell cast followed by a crisp magical impact, short fantasy, classroom safe, no voice",
    durationSeconds: 0.8,
    volume: 0.55,
  },
  {
    id: "act_lifebinder",
    kind: "sfx",
    text: "protective forest renewal spell, leaves and warm chimes swelling softly, short fantasy, classroom safe, no voice",
    durationSeconds: 0.85,
    volume: 0.55,
  },
  {
    id: "lifebinder_tick",
    kind: "sfx",
    text: "gentle restorative leaf-and-chime pulse, warm natural magic, short fantasy, classroom safe, no voice",
  ...
  },
  {
    id: "hymn_cast",
    kind: "sfx",
    text: "legacy healing hymn cast, soft rising choir-chime, short fantasy, classroom safe, no voice",
    durationSeconds: 0.85,
    volume: 0.55,
  },
  {
